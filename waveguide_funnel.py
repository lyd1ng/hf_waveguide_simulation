...
from flow import funnel_particles_e_field, funnel_particles_h_field
import h_modes
...
parser.add_argument("--t", type=float, help="Point of time") 
...
if len(particles) > 0:
    ...
    particles_out_fd.write("No particles in particle list\n")
...
if len(discarded_particles) > 0:
    ...
    discarded_particles_out_fd.write("No particles in discarded particle list\n")
