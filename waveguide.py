...
parser.add_argument("--t_min", type=float, help="The start time", default=0.0, required=True)
parser.add_argument("--t_max", type=float, help="The end time", default=1.0)
parser.add_argument("--t_step", type=float, help="The timestep", default=0.001) 
